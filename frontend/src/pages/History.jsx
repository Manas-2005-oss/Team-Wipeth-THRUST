...
import { getSimulationHistory, deleteSimulation, getSimulationById, } from "../services/simulationHistory";
            ...
            <div className="max-w-6xl mx-auto px-8 py-10">
               ...
               transition-all duration-200"
                ...
                <p className="text-slate-400 mb-10">
                    Access your previous policy simulations.
                </p>
                    ...
                    history.map((item) => (
                        ...
                        >
                                        ...
                                        >
                                            ...
                                            <button
                                                onClick={async (e) => {
                                                    ...
                                                    try {
                                                        const simulation = await getSimulationById(item.id);

                                                        if (!simulation.inputs) {
                                                            alert("This simulation was created before Run Again was available.");
                                                            return;
                                                        }
                            ...
                            <div className="mt-6 grid grid-cols-3 gap-6">
                                ...
                                <div>
                                    <p className="text-slate-400">Inflation</p>
                                    <p className="text-2xl font-bold">
                                        {item.inflation}
                                    </p>
                                </div>
                                ...
                                <div>
                                    <p className="text-slate-400">Unemployment</p>
                                    <p className="text-2xl font-bold">
                                        {item.unemployment}
                                    </p>
                                </div>
