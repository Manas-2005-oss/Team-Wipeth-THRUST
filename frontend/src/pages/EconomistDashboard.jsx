...
>
          ...
          <div
            className={`${
              isPositive ? "text-green-500 drop-shadow-[0_0_6px_rgba(34,197,94,0.6)] transition-transform duration-300 group-hover:scale-110" : "text-red-500 drop-shadow-[0_0_6px_rgba(239,68,68,0.6)] transition-transform duration-300 group-hover:scale-110"
            }`}
          >
